...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Lottie",
            url: "https://s3.amazonaws.com/swift-package-manager/binaries/Lottie/3.4.4/Lottie.3.4.4.xcframework.zip",
            checksum: "f88344f22ee518ea28ab349515e53f05d962d617d11942e6a96a84dd68057bad"
        ),
        .binaryTarget(
            name: "TrueTime",
